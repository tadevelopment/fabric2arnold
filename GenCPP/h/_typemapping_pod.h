...
inline bool UInt32_to_unsigned_int(const Fabric::EDK::KL::UInt32 & from, unsigned int & to) { 
  to = from;
  return true;
}

inline bool unsigned_int_to_UInt32(const unsigned int & from, Fabric::EDK::KL::UInt32 & to) {
  to = from;
  return true; 
}
